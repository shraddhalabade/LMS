        ...
        <div className="dashboard">
            <div className="dashboard-card">
                ...
                <div className={sidebar ? "dashboard-options active" : "dashboard-options"}>
                    ...
                    <p className={`dashboard-option ${active === "getmember" ? "clicked" : ""}`} onClick={() => { setActive("getmember"); setSidebar(false) }}><AccountBoxIcon className='dashboard-option-icon' /> profile </p>
